...
export async function POST(request) {
  try {
    ...
    const row = {
      ...
      public_guest_agreement: input.publicGuestAgreement,
      public_arrival_instructions: input.publicArrivalInstructions,
      public_access_release_hours: input.publicAccessReleaseHours,
