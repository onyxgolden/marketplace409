        ...
        {OPERATING_COST_WORKFLOW_CHOICES.map(
          (choice) => (
            <button
              ...
              className="rounded-xl border border-slate-200 bg-white p-4 text-left text-sm font-black text-slate-900 shadow-sm transition hover:border-blue-400 hover:bg-blue-50 dark:border-slate-800 dark:bg-slate-900 dark:text-slate-50 dark:hover:border-blue-500 dark:hover:bg-slate-800"
            >
              {choice.label}
            </button>
          ),
