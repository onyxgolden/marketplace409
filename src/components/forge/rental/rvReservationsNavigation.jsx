// Owns the RVs & Cabins nav group and its surface mapping as one self-contained unit, deliberately
// separate from RENTAL_NAVIGATION/buildRentalSurface's long-term-rental definitions -- so lifting
// RV/cabin reservation operations into their own app later is a mechanical move of this one file
// (plus its three panel components), not an untangling exercise.
