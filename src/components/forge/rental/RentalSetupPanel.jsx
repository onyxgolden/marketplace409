...
export default function RentalSetupPanel({ initialUnits = [], onNavigate: navigate }) {
  ...
  return (
    <section className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm" data-rental-setup>
      ...
      {units.length > 0 && !showCreate && <button type="button" onClick={() => setShowCreate(true)} className="mt-5 rounded-xl bg-slate-950 px-5 py-3 font-black text-white">+ Add a new property / unit</button>}
