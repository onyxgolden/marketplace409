...
export default function PrivateFinancingBorrowerInvite({ accountId, onInvited }) {
  ...
  return <section aria-labelledby="pf-invite-heading" className="rounded-2xl border border-slate-200 p-5 dark:border-slate-700">
