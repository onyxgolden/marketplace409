...
export const RENTAL_NAVIGATION = Object.freeze([
  ...
  Object.freeze({ label: "Portfolio", items: Object.freeze([{ id: "setup", label: "Property & Unit" }, { id: "reservable-inventory", label: "RV & Short-Term Rentals" }, { id: "reservation-dashboard", label: "RV Operations" }, { id: "reservations", label: "Reservations" }, { id: "tenants", label: "Tenants" }, { id: "leases", label: "Leases" }, { id: "rentec-migration", label: "Rentec Migration" }, { id: "rentec-files", label: "Rentec Files" }]) }),
