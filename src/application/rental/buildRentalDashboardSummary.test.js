...
describe("buildRentalDashboardSummary", () => {
  it("derives actionable exceptions from rental records", () => {
    ...
    expect(summary).toMatchObject({ vacancies: 1, expiringLeases: 1, overdueBalanceCents: 2500, openMaintenance: 2, awaitingSettlement: 1, missingInsurance: 1, missingDeposits: 1, missingMoveInInspections: 1, openSupportCases: 1, occupiedUnits: 1, totalUnits: 2 });
  });
